...
namespace BusinessLayer
{
	public class BALAuthentication
	{
		...
		private DataFactory dataOperation;
		public BALAuthentication()
		{
			validate = new BALValidations();
			dataOperation = new DataFactory();
		}
		...
		{
            return validate.IsValidLogin(user.Username, user.Password);
        }
		bool flag = true;
		...
		public bool Register(User user)
		{
			...
			decision = dataOperation.CreateObject().Register(user);
